  ...
  static const std::vector<FormatCapability> capabilities = [] {
    std::vector<FormatCapabilityV2> legacy{
      ...
      {"mol",
       ...
       true,
       true,
       {"element", "coordinates", "connectivity", "bond_order", "bond_query",
        "bond_stereo", "formal_charge", "isotope", "radical",
        "atom_stereo", "atom_properties", "source_metadata"},
       {"v2000_only", "single_structure", "single_frame",
        "query_atoms_unsupported", "enhanced_stereo_unsupported",
        "semantic_loss_report"},
       "native"},
      {"sdf",
       "structure",
       ...
       {"element", "coordinates", "connectivity", "bond_order", "bond_query",
        "bond_stereo", "formal_charge", "isotope", "radical",
        "atom_stereo", "atom_properties", "data_fields", "source_metadata"},
       {"v2000_only", "single_frame_per_record", "query_atoms_unsupported",
        "enhanced_stereo_unsupported", "single_active_object_export",
        "semantic_loss_report"},
       "native"},
      {"mol2",
       "structure",
